 ...
 */
class getRelationRepositoryService extends App_KernelProdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RelationRepository.php';

        return $container->privates['App\\Repository\\RelationRepository'] = new \App\Repository\RelationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
